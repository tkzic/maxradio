...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 489.0, 150.0, 74.0 ],
					"text" : "todo: \n\nremove devices from menu and just leave files that will play nicely"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 397.0, 94.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 46.0, 435.0, 92.0, 24.0 ],
					"text" : "audioSettings"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 537.0, 189.0, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 47.0, 306.0, 155.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 46.0, 261.0, 60.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"preset_data" : [ 						{
							"number" : 1,
							"data" : [ 5, "obj-16", "slider", "float", 8.115942, 5, "obj-19", "slider", "float", 103.384613000000002, 5, "obj-26", "slider", "float", 11.0, 5, "obj-1", "umenu", "int", 3, 5, "obj-5", "live.gain~", "float", -5.984252, 5, "<invalid>", "number", "int", 1 ]
						}
, 						{
							"number" : 2,
							"data" : [ 5, "obj-16", "slider", "float", 66.550728000000007, 5, "obj-19", "slider", "float", 88.615386999999998, 5, "obj-26", "slider", "float", 11.0, 5, "obj-1", "umenu", "int", 3, 5, "obj-5", "live.gain~", "float", -6.371621, 5, "<invalid>", "number", "int", 2 ]
						}
, 						{
							"number" : 3,
							"data" : [ 5, "obj-16", "slider", "float", 94.608695999999995, 5, "obj-19", "slider", "float", 56.123077000000002, 5, "obj-26", "slider", "float", 5.0, 5, "obj-1", "umenu", "int", 3, 5, "obj-5", "live.gain~", "float", -6.371621, 5, "<invalid>", "number", "int", 3 ]
						}
 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 276.0, 437.0, 42.0, 22.0 ],
					"text" : "*~ 10."
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 264.0, 27.0, 60.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 107.0, 168.0, 32.5, 22.0 ],
									"text" : "0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 148.0, 168.0, 327.0, 62.0 ],
...
,
					"patching_rect" : [ 48.0, 49.0, 73.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 48.388916000000002, 73.0, 191.0, 25.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 493.0, 440.0, 150.0, 47.0 ],
									"text" : " removed offset it was causeing problems with looping"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 255.0, 383.0, 29.5, 22.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 531.0, 325.0, 210.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 388.0, 359.000006258487701, 93.60000079870224, 22.0 ],
									"text" : "t b b l"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 347.0, 503.0, 160.0, 60.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 35.0, 113.0, 150.0, 47.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 31.0, 40.0, 150.0, 33.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 217.0, 217.0, 70.0, 22.0 ],
													"text" : "selector~ 2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "signal" ],
													"patching_rect" : [ 134.0, 219.0, 70.0, 22.0 ],
													"text" : "selector~ 2"
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 355.5, 412.600006699562073, 228.0, 22.0 ],
									"text" : "open 10meter96.wav"
								}
...
, 							{
								"box" : 								{
									...
									"saved_object_attributes" : 									{
										...
										"formantcorrection" : 0,
										"mode" : "basic",
										"originallength" : [ 15843.869999999998981, "ticks" ],
										"originaltempo" : 120.0,
										"pitchcorrection" : 0,
										"quality" : "basic",
										"timestretch" : [ 0 ]
...
,
					"patching_rect" : [ 47.611083999999998, 102.0, 85.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 359.0, 341.0, 120.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 283.0, 255.0, 36.0, 22.0 ],
					"text" : "*~ 1."
				}
...
,
					"patching_rect" : [ 428.0, 299.0, 51.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 411.0, 106.0, 68.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 334.0, 380.0, 122.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 458.0, 214.0, 33.0, 22.0 ],
					"text" : "* -1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 487.0, 186.0, 30.0, 22.0 ],
					"text" : "/ 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 277.0, 410.0, 90.0, 22.0 ],
					"text" : "onepole~ 6000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 245.0, 255.0, 36.0, 22.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 471.0, 161.0, 63.0, 22.0 ],
					"text" : "dspstate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 397.0, 241.0, 132.0, 22.0 ],
